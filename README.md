...
## Environments
- Preview: https://main--catalan-excatops-da--aemysites.aem.page/
- Live: https://main--catalan-excatops-da--aemysites.aem.live/
- Block Library: https://main--catalan-excatops-da--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `catalan-excatops-da` directory in your favorite IDE and start coding :)
